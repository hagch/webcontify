...
enum class ErrorCode(var message: String) {
  ...
  FIELD_IS_PRIMARY_FIELD("Field with name %s of collection with id %s used as primary field"),
  FIELD_USED_IN_RELATION("Field with name %s of collection with id %s used in relation"),
