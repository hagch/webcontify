...
create table WEBCONTIFY_COLLECTION_RELATION(SOURCE_COLLECTION_ID INT NOT NULL,REFERENCED_COLLECTION_ID INT NOT NULL,TYPE WEBCONTIFY_COLLECTION_RELATION_TYPE NOT NULL,NAME TEXT NOT NULL,DISPLAY_NAME TEXT NOT NULL,
    PRIMARY KEY (SOURCE_COLLECTION_ID,REFERENCED_COLLECTION_ID,NAME,TYPE),
...
create table WEBCONTIFY_COLLECTION_RELATION_FIELD(
    ...
    FOREIGN KEY (SOURCE_COLLECTION_ID) REFERENCES WEBCONTIFY_COLLECTION(ID),
    FOREIGN KEY (REFERENCED_COLLECTION_ID) REFERENCES WEBCONTIFY_COLLECTION(ID),
    FOREIGN KEY (SOURCE_COLLECTION_ID,REFERENCED_COLLECTION_ID,TYPE,NAME) REFERENCES WEBCONTIFY_COLLECTION_RELATION(SOURCE_COLLECTION_ID,REFERENCED_COLLECTION_ID,TYPE,NAME)
);
